...
public class EnemyManager : MonoBehaviour {
    ...
    /// <summary>
    /// The reference to the current instance of the game manager
    /// </summary>
    private GameManager _gameManager;

    /// <summary>
    /// The reference to the current instance of the Delayed Action Handler 
    /// </summary>
    ...
    /// <summary>
    /// Fills the queue with the enemies that will be spawned
    /// </summary>
    /// <param name="enemyList">List of enemies to spawn</param>
    ...
    /// <summary>
    /// Removes an enemy form the currently alive enemy list
    /// </summary>
