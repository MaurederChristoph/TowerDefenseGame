...
public class UnitBase : MonoBehaviour {
    ...
    /// <summary>
    /// Chnage the targeting strategy to the saved one
    /// </summary>
    ...
    private void DistributeEffects(List<ScriptableAbilityEffect> projectileEffects, UnitBase origin = null) {
    ...
    private void OnTriggerEnter2D(Collider2D other) {
        ...
        EffectCaster.CastEffect(OnEnemyEnterRangeEffect, BaseProjectile, this, other.GetComponent<UnitBase>());
        Debug.Log(other.name + " enters range");
    }
    private void OnTriggerExit2S(Collider2D other) {
        if(!other.CompareTag(AttackTargetFaction.ToString())) return;
        EffectCaster.CastEffect(OnEnemyLeaveRangeEffect, BaseProjectile, this, other.GetComponent<UnitBase>());
        Debug.Log(other.name + " exits range");
    }
}
